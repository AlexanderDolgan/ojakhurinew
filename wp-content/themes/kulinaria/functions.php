...
function theme_styles() {
	...
	wp_enqueue_style( 'fotorama', 'http://cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.4/fotorama.css', array(), null, 'all' );
}
...
function theme_js() {
	...
	wp_enqueue_script( 'fotorama', 'http://cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.4/fotorama.js', '', '', true );
}
...
$meta_fields = array(
	...
	array(
		'label' => 'адрес 1',
		'desc'  => ' ',
		'id'    => 'adr1', // даем идентификатор.
		'type'  => 'text'  // Указываем тип поля.
	),
	array(
		'label' => 'адрес 2',
		'desc'  => ' ',
		'id'    => 'adr2', // даем идентификатор.
		'type'  => 'text'  // Указываем тип поля.
	),
	array(
		'label' => 'адрес 3',
		'desc'  => ' ',
		'id'    => 'adr3', // даем идентификатор.
		'type'  => 'text'  // Указываем тип поля.
	),
	array(
		'label' => 'адрес 4',
		'desc'  => ' ',
		'id'    => 'adr4', // даем идентификатор.
		'type'  => 'text'  // Указываем тип поля.
	),
	array(
		'label' => 'адрес 5',
		'desc'  => ' ',
		'id'    => 'adr5', // даем идентификатор.
		'type'  => 'text'  // Указываем тип поля.
	),
	array(
		'label' => 'адрес 6',
		'desc'  => ' ',
		'id'    => 'adr6', // даем идентификатор.
		'type'  => 'text'  // Указываем тип поля.
	),
	array(
		'label' => 'адрес 7',
		'desc'  => ' ',
		'id'    => 'adr7', // даем идентификатор.
		'type'  => 'text'  // Указываем тип поля.
	),
	array(
		'label' => 'адрес 8',
		'desc'  => ' ',
		'id'    => 'adr8', // даем идентификатор.
		'type'  => 'text'  // Указываем тип поля.
	),
	array(
		'label' => 'адрес 9',
		'desc'  => ' ',
		'id'    => 'adr9', // даем идентификатор.
		'type'  => 'text'  // Указываем тип поля.
	),
//	array(
