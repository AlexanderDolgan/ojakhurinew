			...
			<div class="row">
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						...
						<div class="item">
							<img src="<?php bloginfo( 'template_directory' ); ?>/images/mainpagegallery/dishes7.jpg"
							     alt="interior7">
						</div>
						<div class="item">
							<img src="<?php bloginfo( 'template_directory' ); ?>/images/mainpagegallery/dishes8.jpg"
							     alt="interior8">
						</div>
						<div class="item">
							<img src="<?php bloginfo( 'template_directory' ); ?>/images/mainpagegallery/dishes9.jpg"
							     alt="interior9">
						</div>
					</div>
					<!-- Controls -->
