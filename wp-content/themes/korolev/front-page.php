...
<section class="hero container-fluid">
    ...
    <div class="hero-img row">
        ...
        // The Query
        $args      = array( 'post_type' => 'structure_page', 'p' => 1689 );
    ...
    <div class="container / about">
        <div class="row">
            ...
            // The Query
            $args = array( 'post_type' => 'structure_page', 'p' => 1573 );
            $the_query = new WP_Query( $args );
        ...
        <div class="container">
            <div class="row">
                <div class="advant-item col-md-4">
                    ...
                    <a href="<?php echo bloginfo('url') . '/foodmenu' ?>" class="btn">Меню</a>
                </div>
                <div class="advant-item col-md-4">
...
<!--                    <a href="#" class="btn">Контакты</a>-->
                ...
                <div class="advant-item col-md-4">
                    ...
                    <a href="<?php echo bloginfo('url') . '/banquets' ?>" class="btn">Подробнее</a>
                </div>
            </div>
        </div>
    </section>
