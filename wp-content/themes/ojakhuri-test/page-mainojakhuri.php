...
<?php get_template_part( 'navigation' ); ?>
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="<?php bloginfo( 'template_directory' ); ?>/images/mainpagegallery/interior1.jpg"
							     alt="interior1">
						</div>
						<div class="item">
							<img src="<?php bloginfo( 'template_directory' ); ?>/images/mainpagegallery/interior2.jpg"
							     alt="interior2">
						</div>
						<div class="item">
							<img src="<?php bloginfo( 'template_directory' ); ?>/images/mainpagegallery/interior3.jpg"
							     alt="interior3">
						</div>
						<div class="item">
							<img src="<?php bloginfo( 'template_directory' ); ?>/images/mainpagegallery/interior4.jpg"
							     alt="interior4">
						</div>
						<div class="item">
							<img src="<?php bloginfo( 'template_directory' ); ?>/images/mainpagegallery/interior5.jpg"
							     alt="interior5">
						</div>
						<div class="item">
							<img src="<?php bloginfo( 'template_directory' ); ?>/images/mainpagegallery/interior6.jpg"
							     alt="interior6">
						</div>
					</div>
					<!-- Controls -->
	...
	<section>
		<div class="container-fluid news-bg">
			<div class="row news">
				<h1 class="news-h1"><a
						href="<?php echo get_post_permalink( 'news' ); ?>"><?php echo get_cat_name( 10 ); ?></a>
				</h1>
